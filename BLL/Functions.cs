...
namespace QUANLYBANHANG.Class
{
    public class Functions
    {
        ...
        public static void Connect()
        {
            ...
            conn.ConnectionString = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=D:\\LTWIN_CUOIKI\\QUANLYBANHANG\\QUANLYBANHANG\\QuanLyBanHang.mdf;Integrated Security=True;Connect Timeout=30";
            conn.Open();
            // kiem tra ket noi
